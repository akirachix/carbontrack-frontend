...
export default function EmissionsHeatmapPage() {
    ...
    return (
        <SidebarLayout>
            <div className="flex flex-col items-center min-h-[calc(100vh-60px)] 2xl:p-10 xl:p-5 lg:p-3">
                <div className="flex justify-end w-16 2xl:ml-350 xl:ml-185 lg:ml-135 space-x-4">
                    <Link href="#"><IoPersonOutline className="text-[#F79B72] 2xl:w-7 2xl:h-7 xl:w-7 xl:h-7 lg:w-4 lg:h-5 cursor-pointer hover:text-[#2A4759]" /></Link>
                </div>
