...
const Button = ({buttonText, variant, onclickHandler, icon, type="button"}: ButtonProps)=>{
    const buttonVariants=()=>{
        switch(variant){
            ...
            case "create":
                return 'bg-[#F79B72]  2xl:p-4 xl:p-2 2xl:w-40 xl:w-30 lg:w-20 2xl:h-15 xl:h-10 lg:h-9 text-white  font-bold 2xl:text-[20px] xl:text-[13px] lg:text-[15px] hover:bg-[#F79B72] transition-colors duration-400 ease-in-out '
            case "update":
